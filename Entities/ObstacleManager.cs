    ...
    public class ObstacleManager : IGameEntity
    {
        ...
        private void SpawnRandomObstacle()
        {
            ...
            if(rng <= cactusGroupSpawnRate)
            {
                ...
                obstacle = new CactusGroup(_spriteSheet, isLarge, randomGroupSize, _trex, new Vector2(DinoRunnerGame.WINDOW_WIDTH, posY));
            ...
            else
            {
                ...
                obstacle = new FlyingDino(_trex, new Vector2(DinoRunnerGame.WINDOW_WIDTH, posY), _spriteSheet);
            }
